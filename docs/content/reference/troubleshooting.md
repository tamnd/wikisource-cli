...
Most of these come down to network reality or how wikisource serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

wikisource rate-limits like any public site. wsrc already paces
...
Where a surface is gated, wsrc reads a cookie or token you supply
...
`wsrc`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what wsrc actually did
