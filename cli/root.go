...
type App struct {
	client *wikisource.Client
	cfg    wikisource.Config
...
func Root() *cobra.Command {
	app := &App{cfg: wikisource.DefaultConfig()}

	root := &cobra.Command{
		Use:   "wsrc",
		Short: "Browse English Wikisource texts",
		Long: `wsrc reads English Wikisource through the public MediaWiki API.
No API key is required. It returns records as table, JSON, JSONL,
CSV, TSV, URLs, or raw text.

wsrc is an independent tool and is not affiliated with Wikisource or the Wikimedia Foundation.`,
		SilenceUsage:  true,
		SilenceErrors: true,
...
func (a *App) setup() error {
	...
	a.client = wikisource.NewClient(a.cfg)
	return nil
}
